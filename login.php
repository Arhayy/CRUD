...
if(isset($_POST['submit'])) {
 ...
 if ($user == null || $pass == null) {
  ...
  $log = $con->prepare("SELECT * FROM admin WHERE username = ?") or die($con->error);
...
<body class="hold-transition login-page" style="background-color: #3e3e3e;">
  <div class="login-box" style="margin-top: 13%; box-shadow: 0 4px 8px 0 royalblue;
  transition: 0.3s;">
    <!-- /.login-logo -->
    <div class="login-box-body">
      <h3 class="login-box-msg"><b>Tabungan</b> Mahasiswa</h3>
  ...
  <!-- jQuery 2.2.3 -->
  <script src="style/css/jquery-2.2.3.min.js"></script>
  <!-- Bootstrap 3.3.6 -->
